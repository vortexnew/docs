...
const config = {
  title: 'VortexNew Docs',
  tagline: 'Documentation for VortexNew',
  ...
  url: 'https://docs.vortexnew.qzz.io',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} VortexDevelopment. All rights reserved.`,
      },
      prism: {
